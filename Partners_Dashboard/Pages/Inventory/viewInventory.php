...
<head>
  ...
  <link rel="stylesheet" href="./editSalesStyles.css" />
    ...
    <main>
      <div class="head-title">
        <div class="left">
          ...
          <ul class="breadcrumb">
            <li>
              <a href="./inventory.php">Inventory Summary</a>
            </li>
      ...
      <div class="edit-sales-container">
        <form class="edit-sales-form" id="editgemForm" action="./updategem.php" method="POST"
          ...
          <div class="form-group">
            ...
            <input type="text" id="shape" name="shape" placeholder="shape" value="<?php echo $row['shape']; ?>"
              required />
          </div>

          <div class="form-group">
            <label for="colour">Color</label>
            <input type="text" id="colour" name="colour" placeholder="Colour" value="<?php echo $row['colour']; ?>"
              required />
          </div>
          ...
          <div class="form-group">
            ...
            <select id="type" name="type">
              ...
              <option value="Emerald" <?php if ($row['type'] === 'Emerald')
                echo 'selected'; ?>>Emerald</option>
              <option value="Sapphire" <?php if ($row['type'] === 'Sapphire')
                echo 'selected'; ?>>Sapphire</option>
              <option value="Amethyst" <?php if ($row['type'] === 'Amethyst')
                echo 'selected'; ?>>Amethyst</option>
              <option value="Diamond" <?php if ($row['type'] === 'Diamond')
                echo 'selected'; ?>>Diamond</option>
            </select>
          </div>

          <div class="form-group">
            <label for="origin">Origin</label>
            <input type="text" id="origin" name="origin" placeholder="Origin" value="<?php echo $row['origin']; ?>"
              required />
          </div>
          ...
          <div class="form-group">
            ...
            <?php if (!empty($row['image'])): ?>
              <div>
                <p>Current Image:</p>
                <img src="../../../uploads/<?php echo htmlspecialchars($row['image']); ?>" alt="Uploaded Image"
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="current_certificate"
          ...
          <div class="form-group">
            ...
            <select id="visibility" name="visibility">
              <option value="show" <?php if ($row['visibility'] === 'show')
                echo 'selected'; ?>>show</option>
              <option value="hide" <?php if ($row['visibility'] === 'hide')
          ...
          <div class="form-group">
            ...
            <select id="availability" name="availability">
              ...
              <option value="notAvailable" <?php if ($row['availability'] === 'notAvailable')
                echo 'selected'; ?>>Not
                Available</option>
              <option value="Bid" <?php if ($row['availability'] === 'Bid')
                echo 'selected'; ?>>Bid</option>
